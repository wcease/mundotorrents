...
addon = xbmcaddon.Addon(id='plugin.video.mundotorrent')
...
lista = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/lista.xml").decode("utf-8"))
tube  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/tube.xml").decode("utf-8"))

play  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/play.m3u").decode("utf-8"))
mag  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/mag.xml").decode("utf-8"))
web  = os.path.join(xbmc.translatePath("special://home/addons/webinterface.kratos/index.html").decode("utf-8"))
playlistv = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/playlistv.xml").decode("utf-8"))
vaddon = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/vaddon.xml").decode("utf-8"))

m3u = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/lista.m3u").decode("utf-8"))
...
def web_conect():
    		...
    		f.write('\n <b> ***** Download de Lista Personalizadas do Kratos ***** </b><BR><BR>')
                ...
                f.write('\n<BR><BR>')
                f.write('\n <a href="http://kratos-addons-kodish.16mb.com/repo/instal/plugin.video.mundotorrent/plugin.video.mundotorrent-3.0.0.zip">Extraia o arquivo coloque as Listas na raiz </a><BR>')
...
base = "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3djZWFzZS9tdW5kb3RvcnJlbnRzL21hc3Rlci8xOHJyTGhRUmpCTUEzZ2Z5RGVaQU42TEM5eG8xR1BERFFU"
tam = len(base)
...
if base[0:4] == "aHR0":
    ...
    tp  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.mundotorrent/resources/scripts/open.mp3").decode("utf-8"))
    xbmc.Player().play(tp)
...
def SKindex():
    addon_log("SKindex")
    getData(off,'')
    msg2 = "https://raw.githubusercontent.com/wcease/mundotorrents/master/alarme"				
    msg = msg2 
